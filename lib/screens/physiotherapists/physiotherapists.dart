...
class PhysiotherapistsScreen extends StatefulWidget {
  ...
  @override
  State<PhysiotherapistsScreen> createState() => _PhysiotherapistsScreenState();
}
...
class _PhysiotherapistsScreenState extends State<PhysiotherapistsScreen> {
  ...
  // Allowed specializations for Physiotherapist view (normalized lowercase strings)
  static const Set<String> _allowedPhysiotherapistsSpecs = {
  ...
  void initState() {
    ...
    _groupedSpecs = _getFilteredGroupedSpecializations(
        widget.initialCategory ?? 'Physiotherapist');
    _boot();
  }
  ...
  Future<void> _getTrainers() async {
    ...
    try {
      ...
      // If no explicit specialization picked, use initialCategory (Angular parity); default to Physiotherapist
      ...
      if (resp.statusCode == 200) {
        ...
        final normalizedAllowed =
            _allowedPhysiotherapistsSpecs.map(_norm).toSet();
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/image/Android Medium - 38.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: _loading
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${_totalCount > 0 ? _totalCount : _filtered.length} Physiotherapist experts available in ${_locationCtrl.text.trim().isNotEmpty ? _locationCtrl.text.trim() : 'your area'}',
                            style: const TextStyle(
                                color: Colors.white,
                                fontSize: 16,
