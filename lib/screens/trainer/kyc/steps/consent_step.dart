        ...
        child: SingleChildScrollView(
          child:
            ...
            CheckboxListTile(
                ...
                title: const Text("I confirm that I have no criminal record.",
            ...
            CheckboxListTile(
                ...
                activeColor:
                    Color.fromARGB((0.25 * 255).round(), 255, 255, 255),
                title: const Text("I agree to platform Health & Safety rules.",
                    style: TextStyle(color: Colors.white)),
                controlAffinity: ListTileControlAffinity.leading),
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const LegalPage(
                      ...
                      assetHtmlPath:
                          'terms', // placeholder (not used in current implementation)
                    ),
                  ),
                );
              },
            ...
            if (widget.isPaid)
              const Padding(
                ...
                child: Text('Activation payment confirmed ✔',
              ...
              const Padding(
                padding: EdgeInsets.only(bottom: 16),
                child: Text(
                    'Activation payment pending (complete in previous step).',
                    style: TextStyle(color: Colors.orangeAccent)),
              ),

            const SubTitle("E-Sign (Handwritten)"),
            SignaturePad(
              onBytes: (bytes) {
            ...
            field(
              ...
              validator: (v) {
                if (!notEmpty(v)) return "Enter date";
            ...
            const Text(
                "By submitting, you agree that the above information is true and you consent to the policies.",
