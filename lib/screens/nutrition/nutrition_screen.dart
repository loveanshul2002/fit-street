...
class NutritionScreen extends StatefulWidget {
  ...
  const NutritionScreen({super.key, this.initialCategory, this.initialName});
...
class _NutritionScreenState extends State<NutritionScreen> {
  ...
  // Allowed specializations for Nutrition view (normalized lowercase strings)
  static const Set<String> _allowednutritionSpecs = {
    'nutrition',
    'sports nutritionist',
  ...
  void initState() {
    ...
    _groupedSpecs = _getFilteredGroupedSpecializations(
        widget.initialCategory ?? 'Nutrition');
    _boot();
  }
  ...
  Future<void> _getTrainers() async {
    ...
    try {
      ...
      // If no explicit specialization picked, use initialCategory (Angular parity); default to Nutrition
      ...
      if (resp.statusCode == 200) {
        ...
        String _norm(String s) => s
            ...
            .trim();
        final normalizedAllowed = _allowednutritionSpecs.map(_norm).toSet();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Find Nutritionists'),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${_totalCount > 0 ? _totalCount : _filtered.length} Nutritionists experts available in ${_locationCtrl.text.trim().isNotEmpty ? _locationCtrl.text.trim() : 'your area'}',
                            style: const TextStyle(
                                color: Colors.white,
                                fontSize: 16,
