...
class _YogaScreenState extends State<YogaScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        if (mounted) setState(() => _yogaTrainers = payloadMatches);
        ...
        if (unknown.isNotEmpty) {
          ...
          if (toAdd.isNotEmpty && mounted) {
            setState(() => _yogaTrainers = [..._yogaTrainers, ...toAdd]);
          }
        }
      } else {
  ...
  List<Map<String, dynamic>> get _filtered {
    ...
    if (q.isEmpty) return _yogaTrainers;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${_filtered.length} Yoga trainer${_filtered.length == 1 ? '' : 's'} available',
